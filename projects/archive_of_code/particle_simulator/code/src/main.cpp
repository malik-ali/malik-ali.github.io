/*
 * Program idea and data files taken directly from Algorithms by Robert Sedgewick and Kevin Wayne.
 * A huge appreciation to them for making such a neat algorithm publicly accessible!
 */
